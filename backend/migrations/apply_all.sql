...
CALL _add_column_if_not_exists('ALUMNI_MOBILE_DEVICE_TOKEN', 'APNS_ENVIRONMENT', 'ENUM(''sandbox'',''production'') NULL DEFAULT NULL AFTER DEVICE_TOKEN');
CALL _add_column_if_not_exists('ALUMNI_MOBILE_DEVICE_TOKEN', 'BUNDLE_ID', 'VARCHAR(255) NULL DEFAULT NULL AFTER APNS_ENVIRONMENT');
ALTER TABLE ALUMNI_MOBILE_DEVICE_TOKEN
