...
-- =============================================================================
-- 050: Sliding photo banner ads and engagement logs
-- =============================================================================
...
-- 050: Banner ads
SELECT 'MAIN_BANNER_AD' AS chk, COUNT(*) AS found FROM information_schema.TABLES WHERE TABLE_SCHEMA=DATABASE() AND TABLE_NAME='MAIN_BANNER_AD';
SELECT 'MAIN_BANNER_AD_IMAGE' AS chk, COUNT(*) AS found FROM information_schema.TABLES WHERE TABLE_SCHEMA=DATABASE() AND TABLE_NAME='MAIN_BANNER_AD_IMAGE';
SELECT 'WEO_BANNER_AD_LOG' AS chk, COUNT(*) AS found FROM information_schema.TABLES WHERE TABLE_SCHEMA=DATABASE() AND TABLE_NAME='WEO_BANNER_AD_LOG';
