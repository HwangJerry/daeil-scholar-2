// AdManagePage — lists ads with tier badges and provides delete action
...
export function AdManagePage() {
  const { data: ads, isLoading, deleteAd } = useAdList();
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            {isLoading ? (
              ...
              ads.map((ad) => (
                <tr key={ad.maSeq} className="border-b border-slate-50 hover:bg-slate-50">
                  ...
                  <td className="px-4 py-3 text-center">
                    <Button variant="ghost" size="icon" onClick={() => handleDelete(ad.maSeq)} title="삭제">
