// AdminHeader — desktop top bar with site title, user site link, and logout action
...
export function AdminHeader() {
  ...
  return (
    <header className="hidden items-center justify-between border-b border-border bg-surface px-6 py-3 md:flex">
