          ...
          <PolicySection id="retention">
            ...
            <Card className="border-border bg-primary-light p-6 shadow-none">
              ...
              <p className="mt-3 text-sm leading-7 text-primary">
                앱에서 ‘회원 탈퇴 및 계정 삭제 요청’을 접수하면 계정 이용이 중지됩니다. 접수 후 안내되는 예약 시각 이후 자동으로 탈퇴를 처리하며 관리자가 그전에 처리를 시작할 수 있습니다. 별도 확인이 필요한 경우 담당자가 처리하고, 결과 안내 기한과 법정 보존 내역은 처리 현황에서 안내합니다. 처리가 지연되면 담당자가 사유와 예정일을 안내합니다. 앱 로그인 화면의 ‘계정 삭제 처리 현황’에서도 결과를 확인할 수 있습니다.
              </p>
            </Card>
