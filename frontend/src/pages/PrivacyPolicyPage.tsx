      ...
      <div className="mx-auto grid max-w-[1080px] gap-10 px-5 py-12 sm:px-8 md:px-6 lg:grid-cols-[15rem_minmax(0,1fr)] lg:gap-16 lg:py-16">
        ...
        <article className="min-w-0" aria-label="개인정보 처리 내용">
          ...
          <PolicySection id="retention">
            ...
            <p>Sentry는 무료 요금제에서 새로 수집하는 오류·성능 기록을 30일간 보관합니다. 무료 요금제 전환 전 신규 계정 체험 기간에 수집한 오류 기록은 최대 90일, 성능 기록은 30일간 보관될 수 있습니다. 보관 기간은 수집 당시 기준이 적용되며 요금제 전환으로 기존 기록의 기간이 단축되지는 않습니다. Sentry의 운영 데이터 백업은 자료 종류에 따라 백업 생성 후 30일 또는 90일에 삭제됩니다. 장학회는 현재 가비아 자동 백업·스냅샷과 서버 이미지 백업을 사용하지 않습니다. 향후 회원정보가 포함된 백업을 도입할 때 보관·삭제 기준을 안내합니다. 계정 삭제 작업에는 백업·업로드 파일·외부 서비스의 해당 개인 데이터 확인도 포함됩니다. 삭제가 확인되지 않은 요청은 완료로 처리하지 않습니다.</p>
