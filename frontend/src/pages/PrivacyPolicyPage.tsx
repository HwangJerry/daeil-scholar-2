      ...
      <div className="mx-auto grid max-w-[1080px] gap-10 px-5 py-12 sm:px-8 md:px-6 lg:grid-cols-[15rem_minmax(0,1fr)] lg:gap-16 lg:py-16">
        ...
        <article className="min-w-0" aria-label="개인정보 처리 내용">
          ...
          <PolicySection id="retention">
            ...
            <dl className="divide-y divide-border">
              <div className="py-4"><dt className="font-semibold text-text-primary">기부금 영수증과 회계 자료</dt><dd className="mt-2 text-sm leading-7">소득세법 제160조의3 또는 법인세법 제112조의2에 따른 보관 의무가 적용되는 기부자별 발급명세는 발급일부터 5년간 보관합니다. 전자기부금영수증 등 법정 예외는 해당 규정에 따릅니다. 상속세 및 증여세법 제51조가 적용되는 공익법인등의 장부와 중요한 증명서류는 해당 사업연도 종료일부터 10년간 보관합니다. 앱 회원 연결·전화번호·기수·학과 등 보존에 불필요한 정보는 삭제하고, 필요한 기부자명·기부일·금액·거래 증빙은 접근을 제한하여 암호화 분리 보관한 뒤 보존 기간이 끝나면 삭제합니다. 개인을 식별할 수 없는 전체 모금 집계는 유지합니다. 이 기간을 모든 기부 내역이나 회원정보에 일괄 적용하지 않으며, 장학회에 적용되는 보존 의무와 자료의 성격에 따라 항목별로 관리합니다.</dd></div>
