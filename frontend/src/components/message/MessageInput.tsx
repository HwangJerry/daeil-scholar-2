      ...
      <div className="flex items-center gap-2 rounded-full border border-border bg-background px-4 py-2">
        ...
        <div className="flex-1 min-w-0 relative">
          <textarea
            ...
            disabled={isPending}
            className="w-full resize-none bg-transparent text-sm text-text-primary outline-none placeholder:text-text-placeholder max-h-32 min-h-6 overflow-y-auto"
          />
          {content.length > CHAR_COUNTER_THRESHOLD && (
            <span className="absolute bottom-0 right-0 text-ds-mini text-text-placeholder">
