...
export const PRIVACY_UPDATED_AT = '2026-09-14';
...
export const PRIVACY_COLLECTION = [
  ...
  {
    title: '휴대폰 인증',
    information: '전화번호, 문자로 받은 인증번호, 인증 요청·확인 시각',
    purpose: '가입할 때 본인 휴대폰이 맞는지 확인하는 데만 사용합니다. 인증번호는 알아볼 수 없는 형태로만 저장하고, 인증 기록은 24시간이 지나면 자동으로 삭제합니다.',
  },
  {
    title: 'Apple·카카오 로그인',
