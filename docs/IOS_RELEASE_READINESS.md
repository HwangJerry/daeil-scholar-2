...
2. Operator details confirmed (2026-09-06): organization `대일외국어고등학교 장학회`, privacy contact person `엄은숙`, official contact email `ghkdwp018@gmail.com`. These are reflected in the privacy draft; this information request is resolved. The foundation footer's separate address has not been changed.
